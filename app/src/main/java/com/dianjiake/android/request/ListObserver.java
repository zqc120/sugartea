...
public abstract class ListObserver<O> implements Observer<BaseListBean<O>> {
    ...
    public void onNext(@NonNull BaseListBean<O> t) {
        if (t == null) {
            ...
            if (CheckEmptyUtil.isEmpty(t.getObj().getList())) {
                ...
                onSuccess(t.getObj().getList(), t.getObj().getPage() == t.getObj().getZongyeshu());
            }
        } else {
    ...
    public abstract void onSuccess(List<O> list, boolean isAll);
