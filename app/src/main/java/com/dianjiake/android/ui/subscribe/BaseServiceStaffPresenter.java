...
public abstract class BaseServiceStaffPresenter<T, V extends BaseListView> implements BaseListPresenter {
    protected V view;
    ...
    public BaseServiceStaffPresenter(V view) {
        super();
        this.view = view;
        items = new ArrayList<>();
    ...
    private BaseServiceStaffPresenter() {
