...
public class CardBean implements Parcelable {
    ...
    public String getKelinqushu() {
        return kelinqushu;
    }

    public void setKelinqushu(String kelinqushu) {
        this.kelinqushu = kelinqushu;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.kelinqushu);
