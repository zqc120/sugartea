...
public class UserInfoBean implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.zhiyeid);
        dest.writeString(this.birthday);
        dest.writeString(this.location);
        dest.writeString(this.cid);
        dest.writeString(this.idpics);
        dest.writeString(this.idpicss);
        dest.writeString(this.if_work);
        dest.writeString(this.qqopenid);
        dest.writeString(this.shequid);
        dest.writeString(this.renzhengtime);
        dest.writeString(this.shanghunicheng);
        dest.writeString(this.zhiyezhao);
        dest.writeString(this.shenheshijian);
        dest.writeString(this.tuijian);
        dest.writeString(this.jinyongshijian);
        dest.writeString(this.shanghujinyong);
        dest.writeString(this.money);
        dest.writeString(this.xinxianshishu);
        dest.writeString(this.xuanshangshu);
        dest.writeString(this.wendashu);
        dest.writeString(this.huodongshu);
        dest.writeString(this.farenwushu);
        dest.writeString(this.jierenwushu);
        dest.writeString(this.xiadanshu);
        dest.writeString(this.jiedanshu);
        dest.writeString(this.renwupinglunshu);
        dest.writeString(this.renwupingfen);
