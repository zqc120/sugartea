...
public class ShopCardBean implements Parcelable {
    ...
    protected ShopCardBean(Parcel in) {
    ...
    public static final Parcelable.Creator<ShopCardBean> CREATOR = new Parcelable.Creator<ShopCardBean>() {
        @Override
        public ShopCardBean createFromParcel(Parcel source) {
            return new ShopCardBean(source);
        }

        @Override
        public ShopCardBean[] newArray(int size) {
            return new ShopCardBean[size];
        }
    };
}
