...
public class CouponScaleHelper {
    ...
    private CouponSnapHelper mLinearSnapHelper = new CouponSnapHelper();
    ...
    private void initWidth() {
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                mCardWidth = mCardGalleryWidth - (int) UIUtil.dp2px(2 * (mPagePadding + mShowLeftCardWidth));
